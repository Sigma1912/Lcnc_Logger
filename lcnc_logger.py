...
class MainWindow(QMainWindow):
    ...
    def loadSettings(self):
        ...
        try:
            ...
            if self.settings.value('digital input enable') == 'true':
                self.dinCB.setChecked(True)
            self.dinSB.setValue(int(self.settings.value('digital input value')))
            if self.settings.value('digital output enable') == 'true':
                self.doutCB.setChecked(True)
            ...
            if self.settings.value('analog input enable') == 'true':
                self.ainCB.setChecked(True)
            ...
            if self.settings.value('analog output enable') == 'true':
                self.aoutCB.setChecked(True)
    ...
    def closeEvent(self, event):
        ...
        self.settings.setValue('digital input enable', self.dinCB.isChecked())
        ...
        self.settings.setValue('analog input enable', self.ainCB.isChecked())
        ...
        self.settings.setValue('analog output enable', self.aoutCB.isChecked())
